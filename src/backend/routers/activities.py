...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced').
                  Activities with no difficulty set are always included.
    """
    ...
    if difficulty:
        # Include activities matching the difficulty OR those with no difficulty set
        # (activities without a difficulty are considered suitable for all levels)
        query["$or"] = [
