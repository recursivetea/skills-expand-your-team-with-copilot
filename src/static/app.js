document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
    ...
    const difficulty = allowedDifficulties.includes(details.difficulty) ? details.difficulty : null;
    if (details.difficulty && !difficulty) {
      console.warn(`Unknown difficulty value "${details.difficulty}" for activity "${name}".`);
    }
    const difficultyBadgeHtml = difficulty
    ...
    activityCard.innerHTML = `
      ...
      <div class="share-buttons">
        ...
        <a class="share-btn share-btn-facebook" href="#" target="_blank" rel="noopener noreferrer" title="Share on Facebook" data-share="facebook" data-activity="${name}">
          <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
        </a>
        <a class="share-btn share-btn-twitter" href="#" target="_blank" rel="noopener noreferrer" title="Share on X (Twitter)" data-share="twitter" data-activity="${name}">
        ...
        <a class="share-btn share-btn-whatsapp" href="#" target="_blank" rel="noopener noreferrer" title="Share on WhatsApp" data-share="whatsapp" data-activity="${name}">
        ...
        <button class="share-btn share-btn-copy" title="Copy link" data-share="copy" data-activity="${name}">
    ...
    const shareButtons = activityCard.querySelectorAll(".share-btn[data-share]");
    shareButtons.forEach((btn) => {
      btn.addEventListener("click", (e) => {
        e.preventDefault();
        const activityName = btn.dataset.activity;
        const schoolName = document.querySelector("header h1")?.textContent || "Mergington High School";
        const shareText = `Check out the ${activityName} at ${schoolName}!`;
